      ...
      <div class="container">
        ...
        <div class="left-operation-panel">
          ...
          <div class="flex-wapper margin-t-8">
            ...
            <div>
              <el-input
                class="el-input-wapper"
                v-model="barrageHeightValue"
                style="width: 220px"
          ...
          <div class="flex-wapper margin-t-8">
            <div>弹幕显示（是否全屏）</div>
            <el-switch
              v-model="fullScreenSwitch"
              style="--el-switch-on-color: #13ce66; --el-switch-off-color: #b2b2b2"
            />
          </div>
          <div class="flex-wapper margin-t-8">
            <div>弹幕暂停（是否暂停）</div>
            <el-switch
              v-model="barragePaused"
              style="--el-switch-on-color: #13ce66; --el-switch-off-color: #b2b2b2"
            />
          </div>
          <div class="flex-wapper margin-t-8">
